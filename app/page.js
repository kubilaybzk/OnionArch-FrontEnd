...
const Links = [
  { name: "Go CreateProduct Page", url: "/CreateProduct" },
  { name: " Go Server Page", url: "/Sunucu" },
    ...
    <>
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        <Image
          ...
          fill
          quality={100}
          className="absolute hidden lg:block inset-0 -z-10 h-full w-full object-cover object-right md:object-center"
        />
        <div
